...
type PlaceReviewDetailDrawerProps = {
  readonly open: boolean;
  readonly detail: PlaceReviewDetail | null;
  readonly loading?: boolean;
  readonly errorMessage?: string | null;
  readonly onClose: () => void;
};

export function PlaceReviewDetailDrawer({
  open,
  detail,
  loading = false,
  errorMessage = null,
  onClose,
}: PlaceReviewDetailDrawerProps) {
  if (!open) return null;
...
export function ModerationHistoryList({
  ...
  readonly events: PlaceReviewDetail["moderation_history"];
}) {

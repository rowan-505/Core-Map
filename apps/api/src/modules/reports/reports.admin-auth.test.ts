...
async function withAuthApp(
    ...
    process.env.JWT_SECRET = env.JWT_SECRET ?? "reports-admin-test-secret";
...
test("GET /admin/reports/:id rejects unauthorized reviewers", async () => {

...
import placeReviewsRoutes from "./modules/place-reviews/place-reviews.routes.js";
import foodRankingRoutes from "./modules/food-ranking/food-ranking.routes.js";
...
import namePairReviewsRoutes from "./modules/name-pair-reviews/name-pair-reviews.routes.js";
...
export async function buildApp() {
    ...
    await app.register(placeReviewsRoutes);
    await app.register(foodRankingRoutes);
    ...
    await app.register(namePairReviewsRoutes);
